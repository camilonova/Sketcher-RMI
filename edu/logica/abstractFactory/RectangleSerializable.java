 ...
 * de <i>Rectangle2D.Double</i> e implementa la interface <i>Serializable</i>.
 * 
 * @author Camilo Nova.
 */
public class RectangleSerializable extends Rectangle2D.Double implements Serializable {

	/**
	 * Constructor de la clase, le envia los parametros recibidos a
	 * la super clase para crear el elemento.
	 ...
	 */
	public RectangleSerializable(double arg0, double arg1, double arg2, double arg3) {
