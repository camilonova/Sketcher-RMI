 ...
 * @author	Jim Graham
 */
class GeneralPathIteratorSerializable implements PathIterator, Serializable {
    int typeIdx = 0;
    int pointIdx   = 0;
    CurveSerializable path;
     ...
     */
    GeneralPathIteratorSerializable(CurveSerializable path) {
	this(path, null);
    }
     ...
     * @see GeneralPath#getPathIterator
     */
    GeneralPathIteratorSerializable(CurveSerializable path, AffineTransform at) {
        this.path = path;
        this.affine = at;
    }
