 ...
 * @author Jim Graham
 */
public class CurveSerializable implements Shape, Cloneable, Serializable {
    /**
     ...
     * @see #WIND_NON_ZERO
     */
    public CurveSerializable(int rule) {
     ...
     * @see #WIND_NON_ZERO
     */
    public CurveSerializable(int rule, int initialCapacity) {
     ...
     * @see #WIND_NON_ZERO
     */
    CurveSerializable(int rule, int initialTypes, int initialCoords) {
	setWindingRule(rule);
     ...
     */
    public CurveSerializable(Shape s) {
	this(WIND_NON_ZERO, INIT_SIZE, INIT_SIZE);
    ...
    CurveSerializable gp = (CurveSerializable) clone();
	if (at != null) {
	    gp.transform(at);
	}
	return gp;
	...
	return new GeneralPathIteratorSerializable(this, at);
    }
    ...
    public Object clone() {
	try {
		CurveSerializable copy = (CurveSerializable) super.clone();
    ...
    CurveSerializable(int windingRule, 
		byte[] pointTypes,
		int numTypes,
		float[] pointCoords,
		int numCoords) {
